        ...
        public mutating func Parse()
        {
            ...
            switch (mc)
            {
                ...
                case 0x01, 0x11, 0x21:
                        ...
                        registers[r] = Fetch();
#if DEBUG
                        print(String(format: "LD {RName(r)}{RName((byte)(r + 1))}, 0x{registers[r]:X2}{registers[r + 1]:X2}"));
#endif
                        Wait(10);
                        return;
                ...
                case 0x31:
                        ...
                        registers[SP] = Fetch();
#if DEBUG
                        print(String(format: "LD SP, 0x{registers[SP]:X2}{registers[SP + 1]:X2}"));
#endif
                        Wait(10);
                        return;
                ...
                case 0x06, 0x0e, 0x16, 0x1e, 0x26, 0x2e, 0x3e:
                        ...
                        registers[r] = n;
#if DEBUG
                        print(String(format: "LD {RName(r)}, 0x{n:X2}"));
#endif
                        Wait(7);
                        return;
...
#if DEBUG
                        print(String(format: "LD A, (0x{addr:X4})"));
#endif
                        Wait(13);
                        return;
...
#if DEBUG
                        print(String(format: "LD (0x{addr:X4}), A"));
#endif
                        Wait(13);
                        return;
...
#if DEBUG
                        print(String(format: "LD HL, (0x{--addr:X4})"));
#endif
                        Wait(16);
                        return;
...
#if DEBUG
                        print(String(format: "LD (0x{--addr:X4}), HL"));
#endif
                        Wait(16);
                        return;
                ...
                case 0x80, 0x81, 0x82, 0x83, 0x84, 0x85, 0x87:
                        ...
                        Add(registers[lo]);
#if DEBUG
                        print(String(format: "ADD A, {RName(lo)}"));
#endif
                        Wait(4);
                        return;
                ...
                case 0xC6:
                        ...
                        Add(b);
#if DEBUG
                        print(String(format: "ADD A, 0x{b:X2}"));
#endif
                        Wait(4);
                        Wait(4);
                        return;
                ...
                case 0x88, 0x89, 0x8A, 0x8B, 0x8C, 0x8D, 0x8F:
                        ...
                        Adc(registers[lo]);
#if DEBUG
                        print(String(format: "ADC A, {RName(lo)}"));
#endif
                        Wait(4);
                        return;
                ...
                case 0xCE:
                        ...
                        Adc(b);
#if DEBUG
                        print(String(format: "ADC A, 0x{b:X2}"));
#endif
                        Wait(4);
                        return;
                ...
                case 0x90, 0x91, 0x92, 0x93, 0x94, 0x95, 0x97:
                        ...
                        Sub(registers[lo]);
#if DEBUG
                        print(String(format: "SUB A, {RName(lo)}"));
#endif
                        Wait(4);
                        return;
                ...
                case 0xD6:
                        ...
                        Sub(b);
#if DEBUG
                        print(String(format: "SUB A, 0x{b:X2}"));
#endif
                        Wait(4);
                        return;
                ...
                case 0x98, 0x99, 0x9A, 0x9B, 0x9C, 0x9D, 0x9F:
                        ...
                        Sbc(registers[lo]);
#if DEBUG
                        print(String(format: "SBC A, {RName(lo)}"));
#endif
                        Wait(4);
                        return;
                ...
                case 0xDE:
                        ...
                        Sbc(b);
#if DEBUG
                        print(String(format: "SBC A, 0x{b:X2}"));
#endif
                        Wait(4);
                        return;
                ...
                case 0xA0, 0xA1, 0xA2, 0xA3, 0xA4, 0xA5, 0xA7:
                        ...
                        And(registers[lo]);
#if DEBUG
                        print(String(format: "AND A, {RName(lo)}"));
#endif
                        Wait(4);
                        return;
                ...
                case 0xE6:
                        ...
                        And(b);
#if DEBUG
                        print(String(format: "AND A, 0x{b:X2}"));
#endif
                        Wait(4);
                        return;
                ...
                case 0xB0, 0xB1, 0xB2, 0xB3, 0xB4, 0xB5, 0xB7:
                        ...
                        Or(registers[lo]);
#if DEBUG
                        print(String(format: "OR A, {RName(lo)}"));
#endif
                        Wait(4);
                        return;
                ...
                case 0xF6:
                        ...
                        Or(b);
#if DEBUG
                        print(String(format: "OR A, 0x{b:X2}"));
#endif
                        Wait(4);
                        return;
                ...
                case 0xA8, 0xA9, 0xAA, 0xAB, 0xAC, 0xAD, 0xAF:
                        ...
                        Xor(registers[lo]);
#if DEBUG
                        print(String(format: "XOR A, {RName(lo)}"));
#endif
                        Wait(4);
                        return;
                ...
                case 0xEE:
                        ...
                        Xor(b);
#if DEBUG
                        print(String(format: "XOR A, 0x{b:X2}"));
#endif
                        Wait(4);
                        return;
                ...
                case 0xB8, 0xB9, 0xBA, 0xBB, 0xBC, 0xBD, 0xBF:
                        ...
                        Cmp(registers[lo]);
#if DEBUG
                        print(String(format: "CP A, {RName(lo)}"));
#endif
                        Wait(4);
                        return;
                ...
                case 0xFE:
                        ...
                        Cmp(b);
#if DEBUG
                        print(String(format: "CP A, 0x{b:X2}"));
#endif
                        Wait(4);
                        return;
...
#if DEBUG
                        print(String(format: "INC {RName(r)}"));
#endif
                        Wait(4);
                        return;
...
#if DEBUG
                        print(String(format: "DEC {RName(r)}"));
#endif
                        Wait(7);
                        return;
...
#if DEBUG
                        print(String(format: "JP 0x{addr:X4}"));
#endif
                        Wait(10);
                        return;
...
#if DEBUG
                        print(String(format: "JP {JCName(r)}, 0x{addr:X4}"));
#endif
                        Wait(10);
                        return;
                ...
                case 0x18:
                        ...
                        registers[PC + 1] = (byte)(addr);
#if DEBUG
                        print(String(format: "JR 0x{addr:X4}"));
#endif
                        Wait(12);
                        return;
...
#if DEBUG
                        print(String(format: "JR {JCName((byte)(r & 3))}, 0x{addr:X4}"));
#endif
                        return;
...
#if DEBUG
                        print(String(format: "DJNZ 0x{addr:X4}"));
#endif
                        return;
                ...
                case 0xCD:
                        ...
                        registers[PC + 1] = (byte)(addr);
#if DEBUG
                        print(String(format: "CALL 0x{addr:X4}"));
#endif
                        Wait(17);
                        return;
...
#if DEBUG
                        print(String(format: "CALL {JCName(r)}, 0x{addr:X4}"));
#endif
                        return;
...
#if DEBUG
                        print(String(format: "RET {JCName(r)}"));
#endif
                        return;
...
#if DEBUG
                        print(String(format: "RST 0x{mc & 0x38:X4}"));
#endif
                        Wait(17);
                        return;
...
#if DEBUG
                        print(String(format: "IN A, (0x{port:X2})"));
#endif
                        Wait(11);
                        return;
...
#if DEBUG
                        print(String(format: "OUT (0x{port:X2}), A"));
#endif
                        Wait(11);
                        return;
				default:
...
#if DEBUG
            print(String(format: "{mc:X2}: {hi:X} {r:X} {lo:X}"));
            //throw new InvalidOperationException("Invalid Opcode: "+mc.ToString("X2"));
#endif
            Halt = true;
        }

        private func JCName(_ condition: byte) -> string
        {
            switch (condition)
            {
                case 0:
        ...
        private mutating func ParseCB(_ mode: byte = 0)
        {
            ...
            switch (hi)
            {
                ...
                case 1:
                        ...
                        Bit(r, reg);
#if DEBUG
                        print(String(format: "BIT {r}, {debug_target}"));
#endif
                        Wait(useHL ? 12 : 8);
                        return;
                ...
                case 2:
                    reg &= (byte)(~(0x01 << r));
#if DEBUG
                    print(String(format: "RES {r}, {debug_target}"));
#endif
                    Wait(useHL ? 12 : 8);
                    break;
                case 3:
                    reg |= (byte)(0x01 << r);
#if DEBUG
                    print(String(format: "SET {r}, {debug_target}"));
#endif
                    Wait(useHL ? 12 : 8);
                    break;
				default:
        ...
        private mutating func ParseED()
        {
            ...
            switch (mc)
            {
                ...
                case 0x4B:
                        ...
                        registers[B] = mem[addr];
#if DEBUG
                        print(String(format: "LD BC, (0x{--addr:X4})"));
#endif
                        Wait(20);
                        return;
                ...
                case 0x5B:
                        ...
                        registers[D] = mem[addr];
#if DEBUG
                        print(String(format: "LD DE, (0x{--addr:X4})"));
#endif
                        Wait(20);
                        return;
...
#if DEBUG
                        print(String(format: "LD SP, (0x{--addr:X4})"));
#endif
                        Wait(20);
                        return;
                ...
                case 0x43:
                        ...
                        mem[addr] = registers[B];
#if DEBUG
                        print(String(format: "LD (0x{--addr:X4}), BC"));
#endif
                        Wait(20);
                        return;
                ...
                case 0x53:
                        ...
                        mem[addr] = registers[D];
#if DEBUG
                        print(String(format: "LD (0x{--addr:X4}), DE"));
#endif
                        Wait(20);
                        return;
...
#if DEBUG
                        print(String(format: "LD (0x{--addr:X4}), SP"));
#endif
                        Wait(20);
                        return;
                ...
                case 0x40, 0x48, 0x50, 0x58, 0x60, 0x68, 0x78:
						...
						registers[F] = f;
#if DEBUG
                        print(String(format: "IN {RName(r)}, (BC)"));
#endif
                        Wait(8);
                        return;
                ...
                case 0x41, 0x49, 0x51, 0x59, 0x61, 0x69, 0x79:
						...
						registers[F] = f;
#if DEBUG
                        print(String(format: "OUT (BC), {RName(r)}"));
#endif
                        Wait(8);
                        return;
...
#if DEBUG
            print(String(format: "ED {mc:X2}: {r:X2}"));
#endif
            Halt = true;
        }
        ...
        private mutating func ParseDD()
        {
            ...
            switch (mc)
            {
                ...
                case 0x21:
                        ...
                        registers[IX] = Fetch();
#if DEBUG
                        print(String(format: "LD IX, 0x{Ix:X4}"));
#endif
                        Wait(14);
                        return;
...
#if DEBUG
                        print(String(format: "LD {RName(mid)}, (IX{d:+0;-#})"));
#endif
                        Wait(19);
                        return;
...
#if DEBUG
                        print(String(format: "LD (IX{d:+0;-#}), {RName(lo)}"));
#endif
                        Wait(19);
                        return;
                ...
                case 0x36:
                        ...
                        mem[(ushort)(Ix + d)] = n;
#if DEBUG
                        print(String(format: "LD (IX{d:+0;-#}), {n}"));
#endif
                        Wait(19);
                        return;
...
#if DEBUG
                        print(String(format: "LD IX, (0x{addr:X4})*"));
#endif
                        Wait(20);
                        return;
...
#if DEBUG
                        print(String(format: "LD (0x{addr:X4}), IX"));
#endif
                        Wait(20);
                        return;
                ...
                case 0x86:
                        ...
                        Add(mem[(ushort)(Ix + d)]);
#if DEBUG
                        print(String(format: "ADD A, (IX{d:+0;-#})"));
#endif
                        Wait(19);
                        return;
                ...
                case 0x8E:
                        ...
                        Adc(mem[(ushort)(Ix + d)]);
#if DEBUG
                        print(String(format: "ADC A, (IX{d:+0;-#})"));
#endif
                        Wait(19);
                        return;
                ...
                case 0x96:
                        ...
                        Sub(b);
#if DEBUG
                        print(String(format: "SUB A, (IX{d:+0;-#})"));
#endif
                        Wait(19);
                        return;
                ...
                case 0x9E:
                        ...
                        Sbc(mem[(ushort)(Ix + d)]);
#if DEBUG
                        print(String(format: "SBC A, (IX{d:+0;-#})"));
#endif
                        Wait(19);
                        return;
                ...
                case 0xA6:
                        ...
                        And(b);
#if DEBUG
                        print(String(format: "AND A, (IX{d:+0;-#})"));
#endif
                        Wait(19);
                        return;
                ...
                case 0xB6:
                        ...
                        Or(b);
#if DEBUG
                        print(String(format: "OR A, (IX{d:+0;-#})"));
#endif
                        Wait(19);
                        return;
                ...
                case 0xAE:
                        ...
                        Xor(b);
#if DEBUG
                        print(String(format: "XOR A, (IX{d:+0;-#})"));
#endif
                        Wait(19);
                        return;
                ...
                case 0xBE:
                        ...
                        Cmp(b);
#if DEBUG
                        print(String(format: "CP A, (IX{d:+0;-#})"));
#endif
                        Wait(19);
                        return;
...
#if DEBUG
                        print(String(format: "INC (IX{d:+0;-#})"));
#endif
                        Wait(7);
                        return;
...
#if DEBUG
                        print(String(format: "DEC (IX{d:+0;-#})"));
#endif
                        Wait(7);
                        return;
...
#if DEBUG
            print(String(format: "DD {mc:X2}: {hi:X} {mid:X} {lo:X}"));
#endif
            Halt = true;
        }
        ...
        private mutating func ParseFD()
        {
            ...
            switch (mc)
            {
                ...
                case 0x21:
                        ...
                        registers[IY] = Fetch();
#if DEBUG
                        print(String(format: "LD IY, 0x{Iy:X4}"));
#endif
                        Wait(14);
                        return;
...
#if DEBUG
                        print(String(format: "LD {RName(r)}, (IY{d:+0;-#})"));
#endif
                        Wait(19);
                        return;
...
#if DEBUG
                        print(String(format: "LD (IY{d:+0;-#}), {RName(lo)}"));
#endif
                        Wait(19);
                        return;
                ...
                case 0x36:
                        ...
                        mem[(ushort)(Iy + d)] = n;
#if DEBUG
                        print(String(format: "LD (IY{d:+0;-#}), {n}"));
#endif
                        Wait(19);
                        return;
...
#if DEBUG
                        print(String(format: "LD IY, (0x{--addr:X4})*"));
#endif
                        Wait(20);
                        return;
...
#if DEBUG
                        print(String(format: "LD (0x{--addr:X4}), IY"));
#endif
                        Wait(20);
                        return;
                ...
                case 0x86:
                        ...
                        Add(mem[(ushort)(Iy + d)]);
#if DEBUG
                        print(String(format: "ADD A, (IY{d:+0;-#})"));
#endif
                        Wait(19);
                        return;
...
#if DEBUG
                        print(String(format: "ADC A, (IY{d:+0;-#})"));
#endif
                        Wait(19);
                        return;
                ...
                case 0x96:
                        ...
                        Sub(mem[(ushort)(Iy + d)]);
#if DEBUG
                        print(String(format: "SUB A, (IY{d:+0;-#})"));
#endif
                        Wait(19);
                        return;
                ...
                case 0x9E:
                        ...
                        Sbc(mem[(ushort)(Iy + d)]);
#if DEBUG
                        print(String(format: "SBC A, (IY{d:+0;-#})"));
#endif
                        Wait(19);
                        return;
                ...
                case 0xA6:
                        ...
                        And(b);
#if DEBUG
                        print(String(format: "AND A, (IY{d:+0;-#})"));
#endif
                        Wait(19);
                        return;
                ...
                case 0xB6:
                        ...
                        Or(b);
#if DEBUG
                        print(String(format: "OR A, (IY{d:+0;-#})"));
#endif
                        Wait(19);
                        return;
                ...
                case 0xAE:
                        ...
                        Xor(b);
#if DEBUG
                        print(String(format: "XOR A, (IY{d:+0;-#})"));
#endif
                        Wait(19);
                        return;
                ...
                case 0xBE:
                        ...
                        Cmp(mem[(ushort)(Iy + d)]);
#if DEBUG
                        print(String(format: "CP A, (IY{d:+0;-#})"));
#endif
                        Wait(19);
                        return;
...
#if DEBUG
                        print(String(format: "INC (IY{d:+0;-#})"));
#endif
                        Wait(7);
                        return;
...
#if DEBUG
                        print(String(format: "DEC (IY{d:+0;-#})"));
#endif
                        Wait(7);
                        return;
...
#if DEBUG
            print(String(format: "FD {mc:X2}: {hi:X2} {lo:X2} {r:X2}"));
#endif
            Halt = true;
        }
